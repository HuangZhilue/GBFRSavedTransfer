...
using GBFRSavedTransfer.Core.Services;
using GBFRSavedTransfer.Models;
using GBFRSavedTransfer.Services;
using GBFRSavedTransfer.ViewModels;
using GBFRSavedTransfer.Views;
    ...
    private async void OnStartup(object sender, StartupEventArgs e)
    {
        ...
        _host = Host.CreateDefaultBuilder(e.Args)
                .ConfigureAppConfiguration(c =>
                {
                    ...
                    c.AddJsonStream(Assembly.GetExecutingAssembly().GetManifestResourceStream("GBFRSavedTransfer.appsettings.json"));
                })
